...
const AboutUs = () => {
  return (
    <div className="px-4 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9">
      <p className="py-4 text-lg font-normal leading-3 cursor-pointer text-orange hover:text-indigo-800">
        About
      </p>
      ...
      <div className="relative mt-24">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-8">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="24" cy="24" r="24" fill="    #ff4605" />
            <path
      ...
      <div className="flex flex-col justify-between gap-16 mt-16 lg:flex-row md:gap-14 lg:mt-20">
        <div className="w-full lg:w-6/12">
          ...
          <p className="w-full mt-6 text-base font-normal leading-6 lg:w-10/12 xl:w-9/12">
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
            by this our present charter confirmed for us and our heirs forever
          ...
          <p className="w-full mt-10 text-base font-normal leading-6 lg:w-10/12 xl:w-9/12">
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
            by this our present charter confirmed for us and our heirs forever
        ...
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                <p className="text-xl font-semibold leading-5 lg:text-2xl lg:leading-6">
                  Team
                </p>
